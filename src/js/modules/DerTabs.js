/*
    <div class="tabs" data-tabs="tab">
        <ul class="tabs__nav">
            <li class="tabs__nav-item">
                <button class="tabs__nav-btn tabs__nav-btn--active" type="button">Кнонка 1</button>
            </li>
            <li class="tabs__nav-item">
                <button class="tabs__nav-btn" type="button">Кнопка 2</button>
            </li>
            <li class="tabs__nav-item">
                <button class="tabs__nav-btn" type="button">Кнопка 3</button>
            </li>
        </ul>
    ...
    ! Обязятельное применение классов и атрибутов, указанных в шаблоне для корректной работы модуля; 
*/

export default class DerTabs {
